...
class FreightService extends StatefulWidget {
  FreightService({Key? key}) : super(key: key);

  @override
  State<FreightService> createState() => _FreightServiceState();
}

class _FreightServiceState extends State<FreightService> {
